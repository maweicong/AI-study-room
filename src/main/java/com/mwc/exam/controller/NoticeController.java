...
import com.mwc.exam.entity.Notice;
import com.mwc.exam.service.NoticeService;
...
public class NoticeController {
    ...
    public Result<List<Notice>> getActiveNotices() {
        Result<List<Notice>> activeNotices = noticeService.getActiveNotices();
        log.info("获取启用的公告：{}", activeNotices.getData());
        return Result.success(activeNotices.getData());
    }
    ...
    public Result<String> addNotice(@RequestBody Notice notice) {
        Result<String> stringResult = noticeService.addNotice(notice);
        return Result.success(stringResult.getMessage(),"操作成功");
    }
    ...
    public Result<String> toggleNoticeStatus(
        ...
        Result<String> stringResult = noticeService.toggleNoticeStatus(id, isActive);
        log.info("切换公告状态：{}", stringResult.getMessage());
        return stringResult;
    }
} 