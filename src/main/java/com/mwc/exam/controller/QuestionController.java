package com.mwc.exam.controller;

import com.mwc.exam.common.Result;
...
public class QuestionController {
    ...
    public Result<Page<Question>> getQuestionList(
            ...
            QuestionQueryVo queryVo) {
        // 创建分页对象
        Page<Question> querypage = new Page<>(page, size);
        //方案二：嵌套查询
        //questionService.selectQuestions(querypage, queryVo);
        questionService.selectQuestionsByStream(querypage, queryVo);
        log.info("分页查询题目列表，参数：{}", queryVo);
        // 返回统一格式的成功响应
    ...
    public Result<Question> getQuestionById(
            ...
            Question question =   questionService.selectQuestionsById(id);
    ...
    public Result<List<Question>> getPopularQuestions(
        ...
        List<Question> questions = questionService.selectHotQuestions(size);
        log.info("获取热门题目，数量为：{}，返回数据：{}",questions.size(), questions);
    ...
    public Result<Integer> refreshPopularQuestions() {
        return Result.success("获取热门题目成功");
    }
