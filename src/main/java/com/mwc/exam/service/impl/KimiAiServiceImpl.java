...
public class KimiAiServiceImpl implements KimiAiService {
    ...
    @Override
    public String callKimiApi(String prompt) throws InterruptedException {
    ...
    public List<QuestionImportVo> generateQuestionsByAi(AiGenerateRequestVo request) throws InterruptedException {
        ...
        //3. 调用kimi调用方法获取结果
        String content = callKimiApi(prompt);
        //4. 结果内容解析
        /*
           ```json
              {
    ...
    public GradingResult gradingTextQuestion(Question question, String userAnswer, Integer maxScore) throws InterruptedException {
        ...
        //2.调用ai模型，获取返回结果
        String content = callKimiApi(gradingPrompt);
    ...
    /*
            ...
            prompt.append("}");
         */
        com.alibaba.fastjson2.JSONObject jsonObject = com.alibaba.fastjson2.JSONObject.from(JSON.parseObject(content));
    ...
    public String buildSummary(Integer totalScore, Integer maxScore, Integer questionCount, Integer correctCount) throws InterruptedException {
        ...
        //2. 调用kimiai
        String summary = callKimiApi(summaryPrompt);
        //3. 结果解析
        return summary;
    }
